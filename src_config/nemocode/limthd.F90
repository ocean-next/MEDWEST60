...
CONTAINS
   ...
   SUBROUTINE lim_thd_1d2d( nbpb, jl, kn )
      ...
      CASE( 1 )
         ...
         !LOLO (otherwize some NaN values):
         at_i_1d = 0.0_wp
         a_i_1d = 0.0_wp
         ht_i_1d = 0.0_wp
         ht_s_1d = 0.0_wp
         ...
         hfx_err_1d = 0.0_wp
         hfx_res_1d = 0.0_wp
         hfx_err_dif_1d = 0.0_wp 
         !LOLO:hfx_err_rem_1d = 0.0_wp 
         !LOLO.
         ...
         !LOLO:CALL tab_2d_1d( nbpb, hfx_err_rem_1d (1:nbpb), hfx_err_rem , jpi, jpj, npb(1:nbpb) )
      ...
      CASE( 2 )
         ...
         !LOLO:CALL tab_1d_2d( nbpb, hfx_err_rem   , npb, hfx_err_rem_1d(1:nbpb), jpi, jpj )
