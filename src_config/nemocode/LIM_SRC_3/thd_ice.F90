MODULE thd_ice
   ...
   !LOLO: REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:) ::   hfx_err_rem_1d
...
CONTAINS
   ...
   FUNCTION thd_ice_alloc()
      ...
      ALLOCATE( npb      (jpij) , nplm      (jpij) , npac       (jpij) ,   &
         ...
         &      hfx_res_1d(jpij) , hfx_err_dif_1d(jpij) , STAT=ierr(1) )
!LOLO:         &      hfx_res_1d(jpij) , hfx_err_rem_1d(jpij) , hfx_err_dif_1d(jpij) , STAT=ierr(1) )
      !
